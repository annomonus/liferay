...
public class PasswordTrackerPersistenceImpl extends BasePersistenceImpl<PasswordTracker>
	 ...
	 */
	public static final String FINDER_CLASS_zoefoley_ENTITY = PasswordTrackerImpl.class.getName(zoe.foley20);
	public static final String FINDER_CLASS_zoefoley_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_zoefoley_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			...
			"findByUserId",
			new String[] {
				Long.class.getName(FINDER_CLASS_zoefoley_ENTITY),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[passwordTracker] { Long.class.getName(zoe.foley20) },
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(zoefoley) });
